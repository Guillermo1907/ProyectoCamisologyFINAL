...
<!DOCTYPE html>
    ...
    <body>
        ...
        <% 
        	...
        	String fotoSrc = (foto != null) ? "data:image/png;base64," + foto : "img/header/iconoperfil.png";
        %>
    ...
    <img id="carrito-icono" src="img/header/carrito.png" alt="Carrito de la compra">
</div>
...
<div id="modal-carrito" class="modal-carrito" style="display:none;"></div>
...
<div id="modal-iniciar-sesion" class="modal" style="display: none;">
    <div class="contenido-modal">
        ...
        <form class="needs-validation" novalidate action="/Vista_Camisology/login" method="POST">
...
<div id="modal-registrarse" class="modal-registrarse">
  ...
  <main>
           <div class="portada">
               <h1>¡Viste tu pasión!</h1>
               <button>COMPRA AHORA</button>
           </div>

            <div class="beneficios">
                <div class="beneficio">
                    <img src="img/iconos/icon_paquete.png" alt="Ícono de Envío">
                    <span>ENTREGAS EN 4-7 DÍAS</span>
                </div>
                <div class="beneficio">
                    <img src="img/iconos/icon_metodopago.png" alt="Ícono de Pago Seguro">
                    <span>MÉTODOS DE PAGO SEGUROS</span>
                </div>
                <div class="beneficio">
                    <img src="img/iconos/icon_promociones.png" alt="Ícono de Ofertas y Promociones">
                    <span>OFERTAS Y PROMOCIONES</span>
                </div>
            </div>

<!-- SECCIÓN LAS MÁS VENDIDAS -->
	<section class="mas-vendidas">
	    <h2>LAS MÁS VENDIDAS</h2>
	    <div class="contenedor-carrusel">
	        <button class="boton-carrusel izquierdo">❮</button>
	        <div class="carrusel" id="carrusel-productos">
	        </div>
    ...
    <h2>Camisetas de Diferentes Ligas</h2>
    <div class="cuadros">
        <div class="cuadro" data-url="/Vista_Camisology/categorias/LaLiga/laliga.jsp">
            <div class="texto-overlay">LALIGA</div>
            <img src="img/camisetasligas/laliga.PNG" alt="LALIGA" class="imagen-cuadro">
        </div>
        <div class="cuadro" data-url="/Vista_Camisology/categorias/PremierLeague/premierleague.jsp">
            <div class="texto-overlay">PREMIER LEAGUE</div>
            <img src="img/camisetasligas/premier.PNG" alt="PREMIER LEAGUE" class="imagen-cuadro">
        </div>
        <div class="cuadro" data-url="/Vista_Camisology/categorias/SerieA/seriea.jsp">
            <div class="texto-overlay">SERIE A</div>
            <img src="img/camisetasligas/serieA.PNG" alt="SERIE A" class="imagen-cuadro">
        </div>
        <div class="cuadro" data-url="/Vista_Camisology/categorias/Bundesliga/bundesliga.jsp">
            <div class="texto-overlay">BUNDESLIGA</div>
            <img src="img/camisetasligas/bundesliga.jpg" alt="BUNDESLIGA" class="imagen-cuadro">
        </div>
    </div>
</div>
